...
public class GdmapAdminActivity extends BaseActivity implements AMap.OnCameraChangeListener,
    ...
    private void setCenterMaker(final LatLng latLng , final float radius, String url) {
        ...
        Utils.load(GdmapAdminActivity.this, url, imgHead, new OnImgLoadFinish() {
            @Override
...
//        mAmap.setMinZoomLevel(15f); //设置地图最小缩放
        ...
        poiItemAdapter = new PoiItemAdapter(GdmapAdminActivity.this, poiItems);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                poiItemAdapter.notifyDataSetChanged();
                GdmapAdminActivity.this.poiItem = poiItems.get(position);
